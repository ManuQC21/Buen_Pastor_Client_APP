...
public class ModificarEquipoValidationHelper {

    public static boolean validarEntradas(Context context, TextInputEditText txtTipoEquipo, TextInputEditText txtDescripcion,
                                          TextInputEditText txtMarca, TextInputEditText txtModelo, TextInputEditText txtNombreDeEquipo,
                                          TextInputEditText txtNumeroDeOrden, TextInputEditText txtNumeroDeSerie, TextInputEditText edtFechaCompra) {
